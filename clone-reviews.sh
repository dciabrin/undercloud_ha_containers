...
# co_repo tripleo-heat-templates haproxy-tht # merged: 473473 459597
# co_repo tripleo-heat-templates mysql-client-tht # merged: 466531
co_repo tripleo-heat-templates use-mysql-client-tht 481965 #
...
for i in use-mysql-client; do (cd $i-tht && link_repo $THT); done

(cd /etc/puppet/modules && rm -rf tripleo && co_repo puppet-tripleo tripleo)
# co_repo puppet-tripleo rabbitmq-pp # merged: 455189
# co_repo puppet-tripleo mysql-pp # merged: 455345
co_repo puppet-tripleo mysqlclient-pp 481554 #
co_repo puppet-tripleo ha-config-generation-pp 477535 #
# co_repo puppet-tripleo clustercheck-pp # merged: 457797
# co_repo puppet-tripleo haproxy-pp # merged: 458832
...
for i in mysqlclient ha-config-generation; do (cd $i-pp && link_repo $PP); done
