...
BUILD_IMGS="mariadb rabbitmq haproxy redis cinder-base cinder-api cinder-backup cinder-scheduler cinder-volume manila-base manila-api manila-data manila-scheduler manila-share"
